...
$topPickPlaces = array_values(array_filter(array_map('normalize_public_business_for_discovery', get_top_pick_business_rows_for_app('', 6)), function ($place) {
    return !empty($place['id']);
}));
...
<div class="page-shell">
    ...
    <header class="topbar">
        <div class="topbar-inner">
            ...
            <nav class="topbar-nav" aria-label="Main navigation">
                ...
                <a class="nav-link" href="Home.php#top-picks">Top picks</a>
    ...
    <main>
        ...
        <?php if ($topPickPlaces): ?>
        <!-- Promotional daily picks managed from the admin panel. -->
        <section class="section" id="top-picks">
            <div class="section-inner">
                <div class="section-head">
                    <div>
                        <span class="section-kicker"><i data-lucide="star"></i>Top Picks for today</span>
                        <h2 class="section-title">Promoted places for today's plans.</h2>
                        <p class="section-desc">These picks are an advertising lane. They also stay available everywhere else in discovery and search.</p>
                    </div>
                    <?php if ($adminLoggedIn): ?>
                    <a class="hero-button secondary" href="admin/top-picks.php"><i data-lucide="settings-2"></i>Manage picks</a>
                    <?php endif; ?>
                </div>

                <div class="places-grid">
                    <?php foreach ($topPickPlaces as $place): ?>
            ...
            <div class="footer-grid">
                ...
                <div class="footer-card">
                    ...
                    <ul>
                        ...
                        <li><a href="Home.php#top-picks">Top picks</a></li>
                        <?php if ($adminLoggedIn): ?>
